...
const PinDescription g_APinDescription[PINS_COUNT] = {
    ...
    // BUZZER_CTL - 9
    {PORTA, 11, PIO_TIMER_ALT, PIN_ATTR_PWM_F, No_ADC_Channel, TCC0_CH3, TC1_CH1, EXTERNAL_INT_NONE},
    ...
    // SERVO4_CTL - 27
    {PORTB, 12, PIO_TIMER_ALT, PIN_ATTR_PWM_G, No_ADC_Channel, TCC0_CH0, TC4_CH0, EXTERNAL_INT_NONE},
    // SERVO3_CTL - 28
    {PORTB, 13, PIO_TIMER_ALT, PIN_ATTR_PWM_G, No_ADC_Channel, TCC0_CH1, TC4_CH1, EXTERNAL_INT_NONE},
    // SERVO2_CTL - 29
    {PORTB, 14, PIO_TIMER_ALT, PIN_ATTR_PWM_G, No_ADC_Channel, TCC0_CH2, TC5_CH0, EXTERNAL_INT_NONE},
    // SERVO1_CTL - 30
    {PORTB, 15, PIO_TIMER_ALT, PIN_ATTR_PWM_G, No_ADC_Channel, TCC4_CH1, TC5_CH1, EXTERNAL_INT_NONE},
